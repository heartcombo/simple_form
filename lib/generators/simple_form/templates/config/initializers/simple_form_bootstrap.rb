...
SimpleForm.setup do |config|
  ...
  # uncomment the assignment below to add `is-valid` class to valid `input_field`
  ...
  # add `valid_class: 'form-group-valid'` below to add `form-group-valid` class into wrapper
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'form-group-invalid' do |b|
    ...
    b.optional :readonly
    b.use :label
    # add `valid_class: 'is-valid'` below to add `is-valid` class into input
